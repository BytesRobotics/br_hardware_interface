...
class TSS
{
	...
	private:
		...
		unsigned long read_delay = 530; //time to wait for the sensor to take reading before asking for data
		...
		long rightlastDebounceTime = 0; //stores when the debounce begins
