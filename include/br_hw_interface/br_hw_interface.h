...
class BRHardwareInterface : public rclcpp::Node{
    ...
    rclcpp::Publisher<sensor_msgs::msg::Range>::SharedPtr front_dist_pub_, front_left_dist_pub_, front_right_dist_pub_, \
    front_left_bottom_dist_pub_, front_right_bottom_dist_pub_, left_dist_pub_, right_dist_pub_, rear_dist_pub_, \
    rear_left_dist_pub_, rear_right_dist_pub_, rear_left_bottom_dist_pub_, rear_right_bottom_dist_pub_;
