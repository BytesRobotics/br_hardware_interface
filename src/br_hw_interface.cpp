...
void BRHardwareInterface::write(std::chrono::steady_clock::duration elapsed_time) {
    ...
    /// Run PIDs
    auto right_cmd = right_pid_.update(angular_velocity_right_setpoint - right_wheel_angular_velocity_, elapsed_time);
    auto left_cmd = left_pid_.update(angular_velocity_left_setpoint - left_wheel_angular_velocity_, elapsed_time);
